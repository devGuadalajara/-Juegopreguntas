...
socket.on('gameQuestions', function(data){
    ...
    document.getElementById('answer1').innerHTML = `<span class="icons">🔺 | </span> ${data.a1} `;
    document.getElementById('answer2').innerHTML = `<span class="icons">⭐ | </span> ${data.a2} `;
    document.getElementById('answer3').innerHTML = `<span class="icons">🔴 | </span> ${data.a3} `;
    document.getElementById('answer4').innerHTML = `<span class="icons">☂️ | </span> ${data.a4} `;
    var correctAnswer = data.correct;
    document.getElementById('playersAnswered').innerHTML = "Jugadores respondieron 0 / " + data.playersInGame;
    updateTimer();
});

socket.on('updatePlayersAnswered', function(data){
   document.getElementById('playersAnswered').innerHTML = "Jugadores respondieron " + data.playersAnswered + " / " + data.playersInGame; 
});
